...
function DailySpill = dailyOilParticles(particlesPerBarrel,DS,spillTiming,Params)
...
% Ask whether we obtain data from a file or not
...
% If particles at surface is predefined
if ~strcmp(Params.surfaceFraction,'auto')
  DailySpill.Surface = DailySpill.Net .* Params.surfaceFraction;
  DailySpill.Subsurf = DailySpill.Net - DailySpill.Surface;
end
end
