...
function [velocities,WindFile,OceanFile] = velocityFields_3(first_time,SerialDay,ts,LagrTimeStep,spillLocation,OceanFile,WindFile,Params)
...
year_str = datestr(date_time,'yy');
%-------------------------Get ocean VectorFields--------------------------%
if first_time
    % Ocean file names and variable names
    OceanFile.Prefix        = [];
    OceanFile.Midfix        = 'years_climatology_';   
    ...
    readOceanFileT2 = [OceanFile.Prefix,year_str,OceanFile.Midfix,day_DoY_str_next,OceanFile.Sufix];
    OceanFile.U_T1 = ncread(readOceanFileT1,OceanFile.Uname,...
        [OceanFile.Lat_min,OceanFile.Lon_min,OceanFile.minDepth_Idx],...
        [OceanFile.Lat_numel,OceanFile.Lon_numel,OceanFile.n_tempDepths]);
    ...
    if flag_one ~= flag_two
        ...
        readOceanFile = [OceanFile.Prefix,year_str,OceanFile.Midfix,day_DoY_str_next,OceanFile.Sufix];
...
if surface_simulation
    if first_time
        ...
        WindFile.Prefix       = [];
        WindFile.Midfix       = 'yearsWRFclimatology_';
        WindFile.Sufix        = '_00_3z.nc';
        WindFile.Uname        = 'u';
        WindFile.Vname        = 'v';
        WindFile.LatName      = 'lat';
        WindFile.LonName      = 'lon';
        % Define variables
        firstFileName = [WindFile.Prefix,year_str,WindFile.Midfix,day_DoY_str,WindFile.Sufix];
        ...
        readWindFileT1 = [WindFile.Prefix,year_str,WindFile.Midfix,day_DoY_str,WindFile.Sufix];
        readWindFileT2 = [WindFile.Prefix,year_str,WindFile.Midfix,day_DoY_str_next,WindFile.Sufix];
